...
public class SearchHistoryEntryController {
    ...
    @RequestMapping(value = "/search-history/{searchHistoryEntryId}", method = RequestMethod.DELETE)
    public ResponseEntity deleteSearchHistoryEntry(@PathVariable Long searchHistoryEntryId) {
